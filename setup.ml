...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5b55a55854d8316b1766ead85f7e1f27) *)
(*
...
let setup_t =
  {
          ...
          description =
            Some
              [
                 ...
                 OASISText.Verbatim "  cab, mtree, and ISO images.";
                 OASISText.Verbatim
                   "* Writes tar, pax, cpio, zip, xar, ar, ISO, mtree, and shar archives.";
                 OASISText.Verbatim
                   "* Full automatic format detection when reading archives, including";
                 OASISText.Verbatim "  compressed archives.";
                 OASISText.BlankLine;
                 OASISText.Para
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_cclib = [(OASISExpr.EBool true, ["-larchive"])];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$htmldir/api-archive";
                      doc_title = "API reference for Archive";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_digest = Some "\2449\\\245Z\236\151\244\183\bg\171;x_;";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
