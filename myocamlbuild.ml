(* OASIS_START *)
(* DO NOT EDIT (digest: cef8eca900d29fa8c295c5c940b3a551) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml =
       [("src/archive", ["src"]); ("src/archive-lwt", ["src"])];
     lib_c = [("archive", "src", [])];
     flags =
       [
          (["oasis_library_archive_cclib"; "link"],
            [(OASISExpr.EBool true, S [A "-cclib"; A "-larchive"])]);
          (["oasis_library_archive_cclib"; "ocamlmklib"; "c"],
